(function(){function I(e,t){document.cookie=e+"="+t+"; path=/"}function se(e){let t=e+"=",r=document.cookie.split(";").map(a=>a.trimStart());for(let a of r)if(a.startsWith(t))return a.substring(t.length);return null}function b(e){if(u()){let t=window.location.href,r={};if(t.indexOf("/watch?")!==-1){let o=t.split("?")[1].split("&");for(let s=0;s<o.length;s++){let y=o[s].split("=");r[decodeURIComponent(y[0])]=decodeURIComponent(y[1])}}else if(t.indexOf("/watch/")!==-1||t.indexOf("/live/")!==-1){let a=t.split("/");r.v=a[a.length-1].split("?")[0]}return r[e]}}function u(){return window.location.href.indexOf("/watch?")!==-1||window.location.href.indexOf("/watch/")!==-1||window.location.href.indexOf("/live/")!==-1}function E(){return window.location.href.indexOf("/shorts/")!==-1}function ue(e){return e.indexOf("/watch?")!==-1||e.indexOf("/watch/")!==-1||e.indexOf("/live/")!==-1}function v(){if(u()){let e=document.querySelector(".video-ads"),t=document.querySelector(".ad-showing");return!!(e&&e.checkVisibility()||t&&t.checkVisibility())}}function p(e){let t="",r="",a=!1,o=0,s=0;e==="t"?(t="t",r="KeyT",a=!1,o=84,s=84):e==="next"?(t="n",r="KeyN",a=!0,o=78,s=78):e==="previous"&&(t="p",r="KeyP",a=!0,o=80,s=80);let y=new Event("focus",{bubbles:!0,cancelable:!0});document.body.dispatchEvent(y);let ge=new KeyboardEvent("keydown",{key:t,code:r,shiftKey:a,keyCode:o,which:s,bubbles:!0,cancelable:!0});document.body.dispatchEvent(ge);let we=new InputEvent("beforeinput",{inputType:"insertText",data:t,bubbles:!0,cancelable:!0});document.body.dispatchEvent(we);let xe=new KeyboardEvent("keypress",{key:t,code:r,shiftKey:a,keyCode:o,which:s,bubbles:!0,cancelable:!0});document.body.dispatchEvent(xe);let Pe=new InputEvent("input",{inputType:"insertText",data:t,bubbles:!0,cancelable:!0});document.body.dispatchEvent(Pe);let ke=new Event("change",{bubbles:!0,cancelable:!0});document.body.dispatchEvent(ke);let Ae=new KeyboardEvent("keyup",{key:t,code:r,shiftKey:a,keyCode:o,which:s,bubbles:!0,cancelable:!0});document.body.dispatchEvent(Ae)}let n=!1,l=!1,g=!1,C=!1,d=!1,i=!1,f=!1,w=!1,x=!1,S=!1,h=!1,W=!1,P=!1,c=!1,m=se("IframeTube_autoplay");m||(m="true",I("IframeTube_autoplay",m));function de(){let e=document.createElement("style");e.textContent=`
    ...
    `,document.head.appendChild(e)}function V(){if(!u())return;document.querySelectorAll("video").forEach(t=>{(!t.paused||!t.muted||t.volume!==0)&&!v()&&(!P||!t.closest("#movie_player"))?(t.muted=!0,t.volume=0,t.pause()):(!t.muted||t.volume!==0||t.paused)&&v()&&(t.muted=!0,t.volume=0,t.play())})}function me(){let e=document.querySelector("ytd-miniplayer");if(e){let t=e.querySelector("video");t&&(!t.paused||!t.muted||t.volume!==0)&&(t.muted=!0,t.volume=0,t.pause())}}let O=!1;function B(){if(!document.body){clearTimeout(O),O=setTimeout(B,100);return}let e=document.createElement("div");e.id="IframeTube_proxyWrapper",e.classList.add("IframeTube_hidden"),document.body.appendChild(e),l=e;let t=document.createElement("style");t.textContent=`
